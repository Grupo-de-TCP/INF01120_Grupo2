...
export interface FAIconProps {
  variant?: "solid" | "regular" | "duotone" | "light" | "brands";
  icon?: string;
...
const loadScript = () => {
  try {
    ...
    script.src = process.env.PUBLIC_FA_URL!;
    (script as any)["data-auto-replace-svg"] = "nest";
...
export const FAIcon = forwardRef((props: FAIconProps, ref) => {
  ...
  return (
    <ErrorBoundary errorMessage={`FAIcon Error: ${icon}`} key={icon}>
